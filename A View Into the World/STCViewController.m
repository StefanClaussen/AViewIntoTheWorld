...
//    NSLog(@"button1 button size (%f, %f", self.button1.bounds.size.height, self.button1.bounds.size.width);
...
//    NSLog(@"button1 center (%f, %f)", self.button1.center.x, self.button1.center.y);
    ...
    NSLog(@"view1 button size (%f, %f", self.view1.bounds.size.height, self.view1.bounds.size.width);
    ...
    NSLog(@"button2 button size (%f, %f", self.button2.bounds.size.height, self.button2.bounds.size.width);
